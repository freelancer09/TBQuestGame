    ...
    public class GameData
    {
        ...
        public static List<GameItem> StandardGameItems()
        {
            return new List<GameItem>()
            {
                ...
                new Food(2002, "Energy Drink", "24oz of pure energy", 25, "Stamina", 5, 5),
                new Food(2003, "Cheese puffs", "Bag of slightly stale cheese puffs.", 5, "Stamina", 10, 1),
                new Food(2004, "Energy shot", "Single serving to keep you going", 15, "Stamina", 40, 1),
                new Food(2005, "Canned mocha", "Doesn't taste very good.", 10, "Stamina", 5, 3),
                new Food(2006, "Slice of pizza", "It's pepperoni, again.", 10, "Stamina", 15, 1),
                new Food(2007, "Chocolate milk", "It's only slightly expired.", 5, "Stamina", 5, 2)
            };
        }
        public static List<Npc> StandardNpcs()
        {
            return new List<Npc>()
            {
                ...
                new Npc(1008, "Calculus Teacher", Character.JobTitle.Teacher, true, true)
                {
                    Skill = "Math",
                    Inventory = new ObservableCollection<GameItem>()
                    {
                ...
                new Npc(1009, "Lunch lady", Character.JobTitle.Faculty, false, false),
                new Npc(1010, "Principal", Character.JobTitle.Faculty, false, false),
                new Npc(1011, "Janitor", Character.JobTitle.Faculty, false, false),
                new Npc(1012, "Coach", Character.JobTitle.Faculty, false, false)
            };
        }
